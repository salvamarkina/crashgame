...
import settings from '../../../assets/rexsettings.svg';
import mainlogo from '../../../assets/rexmainlogo.svg';
import { useEffect, useState, useMemo } from 'react';
import leaderboard from '../../../assets/rexleaderboard.svg';
        ...
        <>
            ...
            >
                <Grid container width="auto">
                    <img src={mainlogo} alt="logo" height={55} />
                </Grid>
                <Grid container width="auto">
                    <Grid
                        container
                    ...
                    >
                        <PeopleRoundedIcon sx={{ color: grey[100], fontSize: 40 }} />
                        <Grid container width="100%" display="flex" justifyContent="center">
                            <Typography
                                textAlign="center"
                                sx={{ color: grey[100], fontWeight: 900, fontSize: { lg: 18, md: 18, sm: 12, xs: 11 } }}
                            >
                    ...
                    >
                        <img src={settings} width={40} alt="icon" />
                        <Grid container width="100%" display="flex" justifyContent="center">
                            <Typography
                                textAlign="center"
                                sx={{ color: grey[100], fontWeight: 900, fontSize: { lg: 18, md: 18, sm: 12, xs: 11 } }}
