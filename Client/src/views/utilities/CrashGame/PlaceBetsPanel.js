...
import { Grid, Typography, TextField, Button, darken } from '@mui/material';
...
const PlaceBetsPanel = () => {
    ...
    const [socket] = useState(() =>
        io('https://alphax.social:3002', {
            secure: true,
            rejectUnauthorized: false,
            transports: ['websocket', 'polling'] // Ensure the correct transport methods are used
        })
    );
                ...
                <Grid container display="flex" justifyContent="center" p={2}>
                    ...
                    <Grid container>
                        <Button
                            ...
                            sx={{
                                color: grey[900],
                                background: `linear-gradient(to right, ${brandColor}, ${darken(brandColor, 0.4)})`,
